...
export class CommentService {
  ...
  getjsp1Comment() {
    this.http.get(CommentService.URL + '?status=jsp1');
  }

  getjsp2Comment() {
    this.http.get(CommentService.URL + '?status=jsp2');
  }

  getjsp3Comment() {
    this.http.get(CommentService.URL + '?status=jsp3');
  }

  getjsp4Comment() {
    this.http.get(CommentService.URL + '?status=jsp4');
  }

  getQuestionComment() {
    this.http.get(CommentService.URL + '?status=question');
  }
  ...
  updateUser(updateComment) {
    this.http.put(CommentService.URL, updateComment);
  }

  deleteComment(id) {
    this.http.delete(CommentService.URL + id);
  }
}
